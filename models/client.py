...
# Test code to create a Client instance
if __name__ == "__main__":
    ...
    # Test hash and verify SSN
    ssn = "123-45-6789"
    hashed_ssn = client.hash_ssn_with_bcrypt(ssn)
    print(client.verify_ssn_with_bcrypt(ssn, hashed_ssn))
